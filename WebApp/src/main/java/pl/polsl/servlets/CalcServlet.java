        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (buttonModel.getDifficultyLevel().equals("default")) {
                ...
                if (name != null && password != null) {
                    PlayerEntity player = new PlayerEntity(name, password);
                    persistObject(player);
                }

                if (difficultyLevel != null) {
                    PlayerEntity player = getPlayerByName(name);
                    if (player != null) {
                        GameEntity game = new GameEntity(difficultyLevel, player);
                        persistObject(game);
                    }
                }
            }
